namespace ConsoleApp1
{
    ...
    // И снова каюсь, сначала хотел взять код с ваши презентаций. Но я сколько не пытался, не работает
    // Час мучался, по итогу код с нейронки. Хотя вот я, честно не понимаю, зачем делать быструю сортировку 
    // Как отдельный метод, хотя в методе Sort она и так быстрая, ну да ладно
    {
